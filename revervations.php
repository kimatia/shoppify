...
$stmt_select_contact = $DB_con->prepare('SELECT * FROM tbl_reservation WHERE id =:uid');
    ...
    ?>
     <div class="col-md-12">
               <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <tbody>
           <?php
  $stmt_select = $DB_con->prepare('SELECT * FROM tbl_reservation');
  $stmt_select->execute();
    ...
    while($row=$stmt_select->fetch(PDO::FETCH_ASSOC))
    {
      ...
      ?>
                <tr>
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <span class=""><a class="btn btn-primary" href="?release_id=<?php echo $row['id']; ?>"><i class=" icon-info-sign" style="color: orange;"></i> Release Request&nbsp;&nbsp;&nbsp;</a></span>
                          </div>
                          <div class="col-md-4">
                            <span class=""><a class="btn btn-primary" href="?delete_id=<?php echo $row['id']; ?>"><i class=" icon-info-sign" style="color: orange;"></i> Delete Request&nbsp;&nbsp;&nbsp;</a></span>
                          </div>
                          <div class="col-md-4">
